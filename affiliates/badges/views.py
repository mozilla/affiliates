...
from affiliates.badges.models import (Badge, BadgeInstance, Category, ClickStats,
                           Leaderboard, Subcategory)
from affiliates.facebook.models import FacebookClickStats
...
from affiliates.shared.utils import current_locale, redirect
