...
from affiliates.badges.models import Badge, BadgeInstance, ClickStats, Subcategory
from affiliates.badges.tests import BadgeInstanceFactory, ClickStatsFactory
