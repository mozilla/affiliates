...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.legacy_banner_instance_id'
        db.add_column(u'links_link', 'legacy_banner_instance_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'Link.legacy_banner_image_id'
        db.add_column(u'links_link', 'legacy_banner_image_id',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.legacy_banner_instance_id'
        db.delete_column(u'links_link', 'legacy_banner_instance_id')

        # Deleting field 'Link.legacy_banner_image_id'
        db.delete_column(u'links_link', 'legacy_banner_image_id')
