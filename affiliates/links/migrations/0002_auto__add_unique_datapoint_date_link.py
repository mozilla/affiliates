...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DataPoint', fields ['date', 'link']
        db.create_unique(u'links_datapoint', ['date', 'link_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataPoint', fields ['date', 'link']
        db.delete_unique(u'links_datapoint', ['date', 'link_id'])
