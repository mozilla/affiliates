...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Link.destination'
        db.delete_column(u'links_link', 'destination')

        # Deleting field 'Link.banner_type'
        db.delete_column(u'links_link', 'banner_type')

        # Adding field 'Link.banner_variation_content_type'
        db.add_column(u'links_link', 'banner_variation_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Link.banner_variation_id'
        db.add_column(u'links_link', 'banner_variation_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Link.destination'
        db.add_column(u'links_link', 'destination',
                      self.gf('django.db.models.fields.URLField')(default='https://www.mozilla.org', max_length=255),
                      keep_default=False)

        # Adding field 'Link.banner_type'
        db.add_column(u'links_link', 'banner_type',
                      self.gf('django.db.models.fields.CharField')(default='image_banner', max_length=255),
                      keep_default=False)

        # Deleting field 'Link.banner_variation_content_type'
        db.delete_column(u'links_link', 'banner_variation_content_type_id')

        # Deleting field 'Link.banner_variation_id'
        db.delete_column(u'links_link', 'banner_variation_id')
