...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookClickStats'
        db.create_table('facebook_facebookclickstats', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('banner_instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facebook.FacebookBannerInstance'])),
            ('hour', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 16, 0, 0))),
            ('clicks', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('facebook', ['FacebookClickStats'])


    def backwards(self, orm):
        # Deleting model 'FacebookClickStats'
        db.delete_table('facebook_facebookclickstats')
