...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookBannerInstance.text'
        db.alter_column('facebook_facebookbannerinstance', 'text', self.gf('django.db.models.fields.CharField')(max_length=90))

    def backwards(self, orm):

        # Changing field 'FacebookBannerInstance.text'
        db.alter_column('facebook_facebookbannerinstance', 'text', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'facebook.facebookclickstats': {
            ...
            'hour': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
