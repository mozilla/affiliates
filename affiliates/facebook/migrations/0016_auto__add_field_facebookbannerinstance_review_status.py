...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookBannerInstance.review_status'
        db.add_column('facebook_facebookbannerinstance', 'review_status',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookBannerInstance.review_status'
        db.delete_column('facebook_facebookbannerinstance', 'review_status')
