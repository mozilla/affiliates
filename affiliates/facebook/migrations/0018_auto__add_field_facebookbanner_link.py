...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookBanner.link'
        db.add_column('facebook_facebookbanner', 'link',
                      self.gf('django.db.models.fields.URLField')(default='https://www.mozilla.org/firefox', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookBanner.link'
        db.delete_column('facebook_facebookbanner', 'link')
    ...
    models = {
        ...
        'facebook.facebookclickstats': {
            ...
            'hour': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
