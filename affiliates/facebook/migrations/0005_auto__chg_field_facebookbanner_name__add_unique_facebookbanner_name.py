...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FacebookBanner.name'
        db.alter_column('facebook_facebookbanner', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
        # Adding unique constraint on 'FacebookBanner', fields ['name']
        db.create_unique('facebook_facebookbanner', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookBanner', fields ['name']
        db.delete_unique('facebook_facebookbanner', ['name'])


        # Changing field 'FacebookBanner.name'
        db.alter_column('facebook_facebookbanner', 'name', self.gf('django.db.models.fields.CharField')(max_length=256))
