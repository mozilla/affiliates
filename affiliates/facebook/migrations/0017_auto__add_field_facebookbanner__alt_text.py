...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookBanner._alt_text'
        db.add_column('facebook_facebookbanner', '_alt_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookBanner._alt_text'
        db.delete_column('facebook_facebookbanner', '_alt_text')
