...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookBannerLocale.image'
        db.add_column('facebook_facebookbannerlocale', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=250),
                      keep_default=False)

        # Adding field 'FacebookBannerLocale.thumbnail'
        db.add_column('facebook_facebookbannerlocale', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookBannerLocale.image'
        db.delete_column('facebook_facebookbannerlocale', 'image')

        # Deleting field 'FacebookBannerLocale.thumbnail'
        db.delete_column('facebook_facebookbannerlocale', 'thumbnail')
    ...
    models = {
        ...
        'facebook.facebookclickstats': {
            ...
            'hour': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
