...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.last_login'
        db.add_column('facebook_facebookuser', 'last_login',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.last_login'
        db.delete_column('facebook_facebookuser', 'last_login')
    ...
    models = {
        ...
        'facebook.facebookclickstats': {
            ...
            'hour': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
