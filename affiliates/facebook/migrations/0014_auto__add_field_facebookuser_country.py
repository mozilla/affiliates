...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookUser.country'
        db.add_column('facebook_facebookuser', 'country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookUser.country'
        db.delete_column('facebook_facebookuser', 'country')
