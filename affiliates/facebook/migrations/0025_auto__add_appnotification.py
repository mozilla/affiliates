...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AppNotification'
        db.create_table('facebook_appnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facebook.FacebookUser'])),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('format_argument', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal('facebook', ['AppNotification'])


    def backwards(self, orm):
        # Deleting model 'AppNotification'
        db.delete_table('facebook_appnotification')
    ...
    models = {
        ...
        'facebook.facebookclickstats': {
            ...
            'hour': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
