...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookBanner.thumbnail'
        db.add_column('facebook_facebookbanner', 'thumbnail',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookBanner.thumbnail'
        db.delete_column('facebook_facebookbanner', 'thumbnail')
