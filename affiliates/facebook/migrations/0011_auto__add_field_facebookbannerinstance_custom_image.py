...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookBannerInstance.custom_image'
        db.add_column('facebook_facebookbannerinstance', 'custom_image',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookBannerInstance.custom_image'
        db.delete_column('facebook_facebookbannerinstance', 'custom_image')
    ...
    models = {
        ...
        'facebook.facebookclickstats': {
            ...
            'hour': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 21, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
