...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookBannerLocale'
        ...
        # Deleting field 'FacebookBanner.locale'
        db.delete_column('facebook_facebookbanner', 'locale')


    def backwards(self, orm):
        # Deleting model 'FacebookBannerLocale'
        db.delete_table('facebook_facebookbannerlocale')
