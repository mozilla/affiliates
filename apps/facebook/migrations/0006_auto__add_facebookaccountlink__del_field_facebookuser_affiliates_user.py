...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookAccountLink'
        db.create_table('facebook_facebookaccountlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('facebook_user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='account_link', unique=True, to=orm['facebook.FacebookUser'])),
            ('affiliates_user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='account_link', unique=True, to=orm['auth.User'])),
            ('activation_code', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('facebook', ['FacebookAccountLink'])

        # Deleting field 'FacebookUser.affiliates_user'
        db.delete_column('facebook_facebookuser', 'affiliates_user_id')


    def backwards(self, orm):
        # Deleting model 'FacebookAccountLink'
        db.delete_table('facebook_facebookaccountlink')

        # Adding field 'FacebookUser.affiliates_user'
        db.add_column('facebook_facebookuser', 'affiliates_user',
    ...
    models = {
        ...
        'facebook.facebookaccountlink': {
            ...
            'affiliates_user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'account_link'", 'unique': 'True', 'to': "orm['auth.User']"}),
            'facebook_user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'account_link'", 'unique': 'True', 'to': "orm['facebook.FacebookUser']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
