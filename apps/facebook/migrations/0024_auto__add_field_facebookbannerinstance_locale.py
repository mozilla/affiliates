...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FacebookBannerInstance.locale'
        db.add_column('facebook_facebookbannerinstance', 'locale',
                      self.gf('shared.models.LocaleField')(default='en-us', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FacebookBannerInstance.locale'
        db.delete_column('facebook_facebookbannerinstance', 'locale')
