...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_userprofile', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

    def backwards(self, orm):

        # Changing field 'UserProfile.website'
        db.alter_column('users_userprofile', 'website', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
