...
project = u'Firefox Affiliates'
copyright = u'2011, Mozilla Corporation'
...
htmlhelp_basename = 'affiliatesdoc'
...
latex_documents = [
  ('index', 'affiliates.tex', u'Firefox Affiliates Documentation',
   u'Mozilla', 'manual'),
]
...
man_pages = [
    ('index', 'affiliates', u"Firefox Affiliates Documentation",
